/*
  bw_sensor_test.ino - test program for line_sensor library.
...
line_sensor bw_sensor(digital_pin_optocouple_led, analog_pin_optocouple, delay_us_between_led_on_and_scan);
